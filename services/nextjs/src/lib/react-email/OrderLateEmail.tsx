...
export function OrderLateEmail({
  order_id,
  total,
  cart,
  checkout,
}: EmailProps) {
  const previewText = `Η παραγγελία σου έχει καθυστερήσει`
        ...
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Text className="text-black text-[14px] leading-[24px] mb-4">
              Λυπούμαστε να σας ενημερώσουμε πως υπήρξε μια απρόοπτη καθυστέρηση
              λόγω φόρτου εργασίας. <br />
              <br />
              <br />
              Επιβεβαιώνουμε πως η παραγγελία θα σταλεί τις επόμενες ημέρες και
              θα ενημερωθείτε με email. <br />
              <br />
              <br />
              Κάνουμε ότι καλύτερο μπορούμε να σας εξυπηρετήσουμε άμεσα. <br />
              <br />
              <br />
